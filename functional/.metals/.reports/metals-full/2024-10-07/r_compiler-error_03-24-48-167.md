...
### file%3A%2F%2F%2Fworkspaces%2Flanguages-wmacevoy%2Ffunctional%2Fhello-world-scala%2Fbuild.sbt:15: error: `)` expected but `string constant` found
...
lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.typesafe" %% "ssl-config-core" % "0.4."
      "org.slf4j" % "slf4j-simple" % "1.7.36"
    )
  )
